...
*   [x] **全链路元数据增强**: 实现时间、地点、张力的自动管理。
*   [x] **分层滑动窗口记忆**: 解决超长篇幅下的注意力稀释问题。
*   [x] **在线图谱编辑器**: 支持直接在 UI 修正实体关系。
*   [ ] **深度语义对齐 (Entity Linking)**: 自动合并同人不同名的实体节点。
*   [ ] **自动化剧情审计**: 引入“读者”角色，从受众视角反馈章节吸引力。
*   [ ] **自定义导出排版**: 支持 EPUB 封面生成与 PDF 模板选择。
